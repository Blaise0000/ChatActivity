...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MyViewHolder> {
   ...
   private static final int VIEW_TYPE_SENT = 1;
    private static final int VIEW_TYPE_RECEIEVED = 2;
    ...
    public void onBindViewHolder(@NonNull MessageAdapter.MyViewHolder holder, int position)
    {
        ...
        {
            holder.textViewReceievedMessage.setText(messageModel.getMessage());
        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView textViewSentMessage, textViewReceievedMessage;

        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            textViewSentMessage = itemView.findViewById(R.id.textViewSentMessage);
            textViewReceievedMessage = itemView.findViewById(R.id.textViewReceivedMessage);
